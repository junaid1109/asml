...
<div class="container-fluid">
    <h2 class="mb-4">Add New About Paragraph</h2>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.about-paragraphs.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control editor @error('details') is-invalid @enderror" id="details" name="details" required>{{ old('details') }}</textarea>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">Create Paragraph</button>
